...
# (!!!) filter for frequency (4 options: hourly (1h), daily (1d), weekly (1wk), monthly (1mo))
def fetch_YFINANCE(symbol: str, start: str, end: str, frequency: str):
# Frequency settings (1h/1d/1wk/1mo) and progress=False to not dipslay the progress bar
